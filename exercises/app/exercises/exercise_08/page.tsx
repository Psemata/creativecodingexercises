...
const Sketch = dynamic(() => import("@/components/sketch_exercise_08"), {
  ssr: false,
});
...
export default function Exercise08() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative p-4">
      ...
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Exercise 08</h1>
